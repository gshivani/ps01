...
(make-point true false);Creates a point structure with "true" in "x" field and "false" in "y" field

(point-x (make-point true false));Creates a point structure with "true" in "x" field and "false" in "y" field and selects point-x instance
